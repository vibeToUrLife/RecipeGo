...
const KEYWORDS: Array<[Aisle, string[]]> = [
  ['Produce', ['tomato','garlic','onion','spinach','lettuce','carrot','potato','pepper','cucumber','lemon','lime','apple','banana','avocado','broccoli','mushroom','celery','ginger','herb','basil','parsley','cilantro','kale','zucchini','cabbage','corn','pea','bean sprout','scallion','shallot']],
