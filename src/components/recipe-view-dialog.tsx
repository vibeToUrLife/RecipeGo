      ...
      <DialogContent className="max-h-[85vh] gap-3 overflow-y-auto sm:max-w-lg">
        ...
        {loading && !recipe ? (
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Shops for this one planned meal, scaled to the stepper above —
                the plan's "add this week" button is all-or-nothing. Sends you
                to the list afterwards, same as the recipe page's copy. */}
            <AddToListButton
              recipeId={recipe.id}
              servings={servings}
              recipeRoomId={recipe.room_id}
              onAdded={onClose}
            />
